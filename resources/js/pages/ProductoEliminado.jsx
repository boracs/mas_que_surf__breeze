    ...
    return (
        <Layout1>
            <div className="min-h-screen bg-gray-50 flex items-center justify-center py-12">
                <div className="p-8 bg-white rounded-lg shadow-lg max-w-lg mx-auto w-full">
                    <h2 className="text-3xl font-semibold text-green-600 mb-6">
                        ¡Producto Eliminado Exitosamente!
                    </h2>
                    <p className="text-lg text-gray-700 mb-6">
                        El producto <strong>{nombreProducto}</strong> ha sido eliminado con éxito de tu carrito.
                    </p>
